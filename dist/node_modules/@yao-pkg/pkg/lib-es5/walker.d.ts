import { FileRecord, FileRecords, Marker, SymLinks, WalkerParams } from './types';
...
declare class Walker {
    ...
    start(marker: Marker, entrypoint: string, addition: string | undefined, params: WalkerParams): Promise<{
        symLinks: SymLinks;
        records: FileRecords;
        entrypoint: string;
    }>;
