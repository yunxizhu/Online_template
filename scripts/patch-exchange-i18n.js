...
const zh = {
  ...
  'lasidao.exchangeHint':
    '已建 {count} 座交易所：任意相同 {n} 个资源 → 任意 1 个资源（无限次，无需工人）',
  'lasidao.exchangeCardTip':
    '无需工人；任意时间将相同资源换成任意 1 个（比例随你持有的交易所数量变化）',
};
const en = {
  ...
  'lasidao.exchangeCardTip':
    'No workers; anytime trade identical resources for any 1 (rate by your exchange count)',
};
